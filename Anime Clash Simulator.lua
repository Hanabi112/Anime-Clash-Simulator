...
local Shop = Ui:Channel("Shop","http://www.roblox.com/asset/?id=7294901968")
...
Main:Label("Auto Function")

Main:Toggle("Auto Hit", _G.Auto_Hit, function(Value)
_G.Auto_Hit = Value
while wait(.1) do
    if _G.Auto_Hit then
        pcall(function()
...
Main:Toggle("Auto Equip", _G.Auto_Equip, function(Value)
_G.Auto_Equip = Value
    while wait(.1) do
    if _G.Auto_Equip then
        pcall(function()
        local args = {
            [1] = "Sword",
            [2] = "EquipSword",
...
Main:Toggle("Auto Sell", _G.Auto_Sell, function(Value)
_G.Auto_Sell = Value
    while wait(.1) do
        if _G.Auto_Sell then
            pcall(function()
            wait(.1)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(257.2705383300781, 12734.0478515625, 677.8829956054688)
            wait(5)
            end)
        end
    end
...
local TP1 = game.Players.LocalPlayer.Character

TP:Toggle("Auto Unlock Island", false, function(Value)
Auto_TP = Value
    if Auto_TP then
        TP1.HumanoidRootPart.CFrame = CFrame.new(204.313, 1019.78, 709.693)

            wait(1)
            TP1.HumanoidRootPart.CFrame = CFrame.new(225.489, 3094.47, 706.057)

                wait(1)
                TP1.HumanoidRootPart.CFrame = CFrame.new(215.422, 6157.2, 731.442)
        
                    wait(1)
                    TP1.HumanoidRootPart.CFrame = CFrame.new(182.713, 9591.26, 751.096)
  
                        wait(1)
                        TP1.HumanoidRootPart.CFrame = CFrame.new(202.396, 12763.5, 739.269)
...
Main:Button("Sell", function()
    TP1.HumanoidRootPart.CFrame = CFrame.new(256.32629394531, 12716.446289062, 681.27337646484)
end)

Main:Button("Shop", function()
    TP1.HumanoidRootPart.CFrame = CFrame.new(257.12155151367, 12716.642578125, 785.76293945312)
end)

Shop:Label("Pet Shop")

Shop:Toggle("AutoGrey Scroll", nil, function(Value)
    Grey_Scroll = Value
    while wait(.1) do
        if Grey_Scroll then
            pcall(function()
...
Shop:Toggle("AutoBlue Scroll", nil, function(Value)
    Blue_Scroll = Value
    while wait(.1) do
        if Blue_Scroll then
            pcall(function()
...
Shop:Button("Grey Scroll", function()
    local args = {
        [1] = "Pets",
        [2] = "BuyPet",
        [3] = {
...
Shop:Button("Blue Scroll", function()
    local args = {
        [1] = "Pets",
        [2] = "BuyPet",
        [3] = {
...
Misc:Button("Server Hop", function()
 DiscordLib:Notification("Server Hop Working", "Wait For Teleport", "OK")
    Teleport()
end)
...
DiscordLib:Notification("Rejoin Working", "Wait For Rejoin", "OK")
